<template>
	<view class="container">
		...
		<view class="login-form">
			...
			<!-- <input type="text" value="" placeholder="企业" v-model="entId" />
			<input type="text" value="" placeholder="设备ID" v-model="devId" /> -->
				...
				uni.request({
					...
					success: (res) => {
						...
						if (res.data.status == 200) {
							...
							console.log(JSON.stringify(res.data.devs) )
